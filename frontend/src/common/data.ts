export const FAQsData = [
  ...
  },
  {
    ...
    answer:
      "Nuestras longanizas se elaboran con condimentos naturales, como sal, ajo, orégano, naranja agria y ajíes longanizeros, lo que las hace 100% naturales. Además, para su preparación se utiliza únicamente tripa de cerdo, sin colorantes ni conservantes sintéticos o artificiales.",
  },
  {
    ...
    answer: `La longaniza es parte de la herencia de miles de personas en Santana, Higüey, donde muchas de las recetas más atesoradas no solo reflejan una gran parte de la identidad del pueblo, sino que también evidencian claramente los orígenes de sus tradiciones y cultura. 
      Esta longaniza figura entre los nominados a los <strong>Gourmand World Cookbook Awards</strong> y su historia se puede apreciar mejor leyendo el libro "Longaniza Dominicana" (subtitulado como “La mejor longaniza del Caribe”) por Féliz-Camilo. 
       <a href="https://shorturl.at/1J7xZ" target="_blank" rel="noopener noreferrer" class="text-blue-600 underline">Más información en este enlace</a>.`,
  },
  {
    ...
    answer: `La longaniza es vendida por personas humildes en negocios familiares o en el mercado local. 
      Puedes ver cómo luce en la mayoría de los negocios en Santana 
      <a href="https://shorturl.at/ND9Ir" target="_blank" rel="noopener noreferrer" class="text-blue-600 underline">aquí</a>.`,
  },
];
