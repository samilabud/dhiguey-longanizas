  ...
  return (
    <div className="min-h-screen text-gray-800 py-8 px-4">
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-8">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-4">1. Términos</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-4">2. Licencia de Uso</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-4">4. Limitaciones</h2>
        <p className="mb-4">
